...
public class CommonConstants {
    ...
    // task panel config
    public static final Dimension TASKPANEL_SIZE = new Dimension(GUI_SIZE.width/2 - 30, GUI_SIZE.height - 175);

    // add task button config
    public static final Dimension ADDTASK_BUTTON_SIZE = new Dimension((GUI_SIZE.width/2)-25, 50);
    ...
    public static final Dimension DELETE_BUTTON_SIZE = new Dimension((int)(TASKFIELD_SIZE.width * 0.12)/2, 50);
}
